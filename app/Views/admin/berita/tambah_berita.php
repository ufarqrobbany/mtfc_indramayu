        ...
        <div class="row">
            <div class="col-12">
                <div class="card card-primary overflow-hidden">
                    <form action="<?= base_url(); ?>admin/berita/add" method="post" enctype="multipart/form-data">
                        <?= csrf_field(); ?>
                        ...
                        <div class="card-body">
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <div class="input-group">
                                        <div class="custom-file">
                                            <input type="file" class="custom-file-input" id="exampleInputFile" name="thumbnail" accept=".jpg, .jpeg, .gif, .png" required>
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="summernote" rows="12" name="isi" required></textarea>
                            </div>
                        </div>
                    </form>
                </div>
