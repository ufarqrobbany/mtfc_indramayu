        ...
        <div class="row">
            <div class="col-6">
                <div class="card card-primary overflow-hidden">
                    <form action="<?= base_url(); ?>admin/tim/save/<?= $tim->id_tim ?>" method="post" enctype="multipart/form-data">
                        <?= csrf_field(); ?>
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <div class="custom-file">
                                        ...
                                        <label class="custom-file-label" for="exampleInputFile"><?= $tim->foto ?></label>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="nama" class="form-control" value="<?= $tim->nama ?>" required>
                            </div>
                            <div class="form-group">
                                <label>Jabatan <span class="text-danger">*</span></label>
                                <input type="text" name="jabatan" class="form-control" value="<?= $tim->jabatan ?>" required>
                            </div>
                        </div>
                    </form>
                </div>
