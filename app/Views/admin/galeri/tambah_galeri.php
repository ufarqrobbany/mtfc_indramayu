        ...
        <div class="row">
            <div class="col-6">
                <div class="card card-primary overflow-hidden">
                    <form action="<?= base_url(); ?>admin/galeri/add" method="post" enctype="multipart/form-data">
                        <?= csrf_field(); ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" id="exampleInputFile" name="foto" accept=".jpg, .jpeg, .gif, .png" required>
